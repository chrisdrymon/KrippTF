...
pickleOut = open('/home/chris/Desktop/oldDeckDic.pkl', 'wb')
...
oldDf = pd.read_csv('/home/chris/Desktop/hyperparams.csv')
...
oldDf.to_csv('/home/chris/Desktop/hyperparams.csv', index=False)
